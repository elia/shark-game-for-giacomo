...
Releasy::Project.new do
  ...
  add_build :osx_app do
    url "com.eliae-societas.squalo"
    wrapper File.expand_path('~/Downloads/Safari/gosu-mac-wrapper-0.7.41.tar.gz') # Assuming this is where you downloaded this file.
